...
@KeepClass
public class CPacketWelcome implements IMessage
{
    public List<AiMineUser> players;

    public CPacketWelcome()
    {
    }

    public CPacketWelcome(Collection<AiMineUser> players)
    {
    ...
    public void fromBytes(ByteBuf buf)
    {
        ...
        {
            players = (List<AiMineUser>) in.readObject();
        }
        catch (Exception e)
        {
    ...
    public static class Handler implements IMessageHandler<CPacketWelcome, IMessage>
    {
        public IMessage onMessage(CPacketWelcome message, MessageContext ctx)
        {
            PacketHandler.handleWelcome(message);
            return null;
        }
    }
}
